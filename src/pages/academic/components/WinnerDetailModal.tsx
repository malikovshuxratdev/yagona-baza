            ...
            <DialogContent className="sm:max-w-lg max-h-[90vh] overflow-y-auto">
                ...
                <div className="space-y-5 py-2">
                    ...
                    <div className="rounded-lg border border-gray-100 bg-gray-50/50 p-4">
                        <h4 className="mb-3 text-sm font-semibold text-gray-700">Olim / Tadqiqotchi</h4>
                    ...
                    {/* Project & Amount */}
                    <div className="rounded-lg border border-gray-100 bg-gray-50/50 p-4">
                        <h4 className="mb-3 text-sm font-semibold text-gray-700">Loyiha va mablag'</h4>
                        <div className="space-y-2 text-sm">
                    ...
                    {receiver_organization && (
                        <div className="rounded-lg border border-gray-100 bg-gray-50/50 p-4">
                            <h4 className="mb-3 text-sm font-semibold text-gray-700">Qabul qiluvchi tashkilot</h4>
                            <div className="space-y-2 text-sm">
                    ...
                    {sender_organization && (
                        <div className="rounded-lg border border-gray-100 bg-gray-50/50 p-4">
                            <h4 className="mb-3 text-sm font-semibold text-gray-700">Yuboruvchi tashkilot</h4>
                            <div className="space-y-2 text-sm">
